...
//   ae- イオンシネマ
//   smt- 松竹マルチプレックスシアターズ（MOVIX・ピカデリー・東劇）
//   c109- 109シネマズ
//   tj-  T・ジョイ（新宿バルト9 ほか）
//   toho- TOHOシネマズ
...
import { C109_PREFIX, c109Theaters, load109 } from './cinemas109.js';
import { SMT_PREFIX, smtTheaters, loadSmt } from './shochiku.js';
import { TJOY_PREFIX, tjoyTheaters, loadTjoy } from './tjoy.js';
import { TOHO_PREFIX, tohoTheaters, loadToho } from './toho.js';
...
export const CHAINS = [
  ...
  },
  {
    id: 'smt',
    prefix: SMT_PREFIX,
    label: '松竹（MOVIX・ピカデリー）',
    theaters: smtTheaters,
    load: loadSmt,
  },
  {
    id: 'c109',
